...
def solve_grid_puzzle(image_path, x_cut=3, y_cut=3):
    # initialization and read image
    img, imgRow, imgCol, imgChn = readImg.read_image(image_path, cv2.IMREAD_COLOR)
    ...
    cv2.imwrite(f'../results/{time.time()}.jpg', temp)
